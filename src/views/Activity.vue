<template>
    <div class="container px-4 py-4 my-4" id="Activity">
        <h2 class="m pb-3 mb-2 text-center fw-bold py-5 my-5 text-uppercase">Activity</h2>
        <p class="m pb-3 mb-2 text-center text-uppercase">การมีส่วนเรียนกิจกรรมต่างๆโดยส่วนใหญ่จะเป็นสตาฟในการจัดกิจกรรมของสาขา</p>
